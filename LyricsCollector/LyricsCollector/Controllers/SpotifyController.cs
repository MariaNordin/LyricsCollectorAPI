...
namespace LyricsCollector.Controllers
{
    public class SpotifyController : Controller
    {
        ...
        public class SpotifyController : ControllerBase
        {
            ...
            public SpotifyTokenModel _token; // public field är tillfälig lösning - använd design pattern, typ command
            public UserResponseModel _user; //     - " -
                                            //AuthorizationResponseModel authorization;

            public SpotifyController(ISpotifyService spotifyService, IHttpClientFactory clientFactory)
            {
